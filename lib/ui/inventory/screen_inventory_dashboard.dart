  ...
  List<_InventoryModule> _inventoryModules(BuildContext context, String brandId) {
    ...
    return [
      ...
      _InventoryModule(
        ...
        subtitle: 'Request supplier stock',
        icon: Icons.receipt_long,
        color: cs.secondary.withValues(alpha: 0.9),
        route: '/brands/$brandId/inventory/purchase-orders',
      ),
      _InventoryModule(
        title: 'Goods Receipts',
        subtitle: 'Receive supplier stock',
        icon: Icons.download_rounded,
        color: cs.secondary.withValues(alpha: 0.75),
        route: '/brands/$brandId/inventory/goods-receipts',
      ),
      _InventoryModule(
        title: 'Supplier Invoices',
        subtitle: 'Record supplier billing',
        icon: Icons.description_outlined,
        color: cs.secondary.withValues(alpha: 0.6),
        route: '/brands/$brandId/inventory/supplier-invoices',
      ),
      _InventoryModule(
        title: 'Adjustments',
      ...
      _InventoryModule(
        ...
        subtitle: 'Request internal stock',
        icon: Icons.assignment_outlined,
        color: cs.secondary.withValues(alpha: 0.55),
        route: '/brands/$brandId/inventory/indents',
      ),
      _InventoryModule(
        title: 'Transfers',
      ...
      _InventoryModule(
        ...
        subtitle: 'Group raw materials',
        icon: Icons.folder_open,
        color: cs.secondary.withValues(alpha: 0.4),
        route: '/brands/$brandId/inventory/groups',
      ),
      _InventoryModule(
        title: 'Material Taxes',
        subtitle: 'Configure material taxes',
        icon: Icons.percent,
        color: cs.primary.withValues(alpha: 0.4),
        route: '/brands/$brandId/inventory/taxes',
      ),
      _InventoryModule(
        title: 'Bill Types',
        subtitle: 'Invoice billing types',
        icon: Icons.receipt_long,
        color: cs.tertiary.withValues(alpha: 0.8),
        route: '/brands/$brandId/inventory/bill-types',
      ),
      _InventoryModule(
        title: 'Stock Reasons',
        subtitle: 'Adjustment reasons',
        icon: Icons.assignment_late_outlined,
        color: cs.tertiary.withValues(alpha: 0.6),
        route: '/brands/$brandId/inventory/reasons',
      ),
      _InventoryModule(
        title: 'Reports',
